...
INSERT INTO PJ (player_name, pj_id, pj_name, pj_genre, pj_level, pj_experience, pj_race, pj_class) VALUES ('JavieraP', 4, 'Phoebe Nix', 'F', 1, 0, 'Mediano', 'Monje');
...
INSERT INTO PJ (player_name, pj_id, pj_name, pj_genre, pj_level, pj_experience, pj_race, pj_class) VALUES ('CarlaB', 7, 'Latte Ectrie', 'F', 1, 0, 'Draconido', 'Hechicero');
...
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('JavieraP', 4, 1, 'Truman', 'Hace un campo gigante de 25 metros a su alrededor (en forma de cubo de 15625 metros^3 con el centro en el usuario) en el cual se curara cualquier ser conciderado aliado mientras dure este efecto. Cada cura es 1D6.');
...
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('CarlaB', 7, 1, 'Duke', 'Panda Rojo. Stats: 9STR ; 15DEX ; 18CON ; 12INT ; 8WIS ; 9CAR. Defiende al usuario y a sus aliados en base al ataque que el enemigo realice. En caso que sea un ataque fisico, formara una burbuja que absorba parte del dano. Si es un ataque magico generara un ligero campo que se deshara de los ataques magicos mas debiles y debilitara los mas fuertes. Los efectos de los ataques no seran ni absorbidos ni reflejaods de ninguna manera por las barreras anteriormente mencionadas.');
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('RaquelA', 8, 1, 'Princesita', 'OsoBuho. Stats: 18STR ; 14DEX ; 16CON ; 8INT ; 6WIS ; 10CAR. Ataca con sus garras afiladas, haciendo 2d12 de daño + sangrado a partir de "AC_enemigo + 2". Cualquier daño que reciba ella o su usuaria agregara + 1D4 a sus ataques.');
