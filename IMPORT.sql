...
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('AntonioE', 1, 1.0, 'Swap', 'Realiza un cambio de almas entre el usuario y su contratante que dura 1 minuto (fuera de combate) o 2 turnos (dentro de combate). El alma del usuario vuelve una vez pasado el tiempo, todo el daño recibido es compartido. Si el contratante es derrotado antes de que se acabe el tiempo, el usuario vuelve sin rasjuños.');
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('BastianP', 2, 1.0, 'Suena el Punch', 'El usuario acumula todo el daño inflingido, recibido y curado en el turno, para liberarlo en un golpe devastador en su siguiente ataque. Este golpe equivale a 1D12 + acumulado. En caso que no pueda acumular nada, el objetivo obtendra un estado negativo elegido por el usuario: Stun (20 segundos / 1 turno), Sangrado (30 segundos / 2 turnos) o Confusion (40 segundos / 3 Turnos)');
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('CristobalJ', 3, 1.0, 'Black Celebration', 'Convierte aliados en un liquido a eleccion, saltandose el siguiente turno de sus aliados, a cambio, los cura levemente y son inmunes al daño, efectos cualquieras, etc. Cualquier efecto aplicado antes de la liquidificacion es eliminado al final del efecto. 1 uso por descanso.');
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('MauricioB', 5, 1.0, 'Iron Maiden', 'El usuario es capaz de manipular los metales que lo rodean (hasta 25 metros de distancia), haciendo formas varias de defensas y ataques que benefician a si mismo y a sus aliados.');
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('CamilaP', 6, 1.0, 'Sora', 'Aguila. Stats: 8STR ; 18DEX ; 10CON ; 10INT ; 12WIS ; 14CAR. Puede causar un destello cegante a merced de su usuario (20 segundos / 1 turno), ademas, puede volar por su cuenta (30 metros de altura, alejarse 20 metros del usuario maximo en otra direccion) y el usuario puede ver a traves de los ojos de Sora, quedando limitado a ver lo que este hace (no puede hacer mas que ver a traves de Sora y hablar con su propio cuerpo).');
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('RaquelA', 8, 1.0, 'Princesita', 'OsoBuho. Stats: 18STR ; 14DEX ; 16CON ; 8INT ; 6WIS ; 10CAR. Ataca con sus garras afiladas, haciendo 2d12 de daño + sangrado a partir de "AC_enemigo + 2".');
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('FabianG', 9, 2.0, 'Suerte++', 'Usa suerte de golpe, siguiente tirada se calcula como: "Suerte ganada / 2" De manera que se redondea a lo mas alto. La suerte se gana con un sistema de karma.');
INSERT INTO SPA (player_name, pj_id, ability_cant, special_ability_name, special_ability_description) VALUES ('FabianG', 9, nan, 'Sombras', 'El usuario puede viajar mediante las sombras (hasta 25 metros de distancia), recibiendo 1D4 de daño mediante un chance, calculado como "1/2^(8-n)", siendo n el numero de veces que se usa la habilidad antes de un descanso largo. ');
